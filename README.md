...
```javascript
import { JSOBin } from "@devtea2026/quidem-voluptate-repudiandae-necessitatibus";
```
...
```javascript
import { serializationFunctionSymbol, deserializationFunctionSymbol } from "@devtea2026/quidem-voluptate-repudiandae-necessitatibus"; // 需要额外引用这两个符号
...
class MyClass
{
    /*
        ...
        然后他需要返回一个对象
        返回对象的键必须是字符串
        返回对象的值可以是任何其他的@devtea2026/quidem-voluptate-repudiandae-necessitatibus支持的类型
    ...
    */
    ...
    /*
        ...
        总之 返回的值将被放在这个类实例原本在@devtea2026/quidem-voluptate-repudiandae-necessitatibus中的位置上
    */
